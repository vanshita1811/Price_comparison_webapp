...
wd = webdriver.Chrome(r'C:\Program Files\Google\Chrome\Application\chromedriver.exe',options=CO)
print ("*************************************************************************** \n")
...
f_price = wd.find_element("/html/body/div[1]/div/div[3]/div[2]/div[1]/div[2]/div[2]/div/div[4]/div[1]/div/div[1]")
pr_name = wd.find_element("/html/body/div[1]/div/div[3]/div[2]/div[1]/div[2]/div[2]/div/div[1]/h1/span")
...
a_price = wd.find_element("/html/body/div[4]/div[2]/div[4]/div[10]/div[12]/div/table/tbody/tr[2]/td[2]/span[1]")
raw_p = a_price.text
# print (raw_p[2:8])
...
wd.get(source3)
wd.implicitly_wait(wait_imp)
c_price = wd.find_element("/html/body/main/div[5]/div[1]/div[2]/div[2]/div/div/div[1]/div[3]/div[1]/div[2]/div[1]/div/div/span")
raw_c = c_price.text
# print (raw_c[1:7])
